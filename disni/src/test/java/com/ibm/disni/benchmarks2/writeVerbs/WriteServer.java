...
/**
 * java -cp disni-1.6-jar-with-dependencies.jar:disni-1.6-tests.jar com.ibm.disni.benchmarks2.writeVerbs.WriteServer -a 10.10.0.93 -s 16 -k 1000
 */
public class WriteServer implements RdmaEndpointFactory<WriteServer.WriteServerEndpoint> {
    private RdmaActiveEndpointGroup<WriteServerEndpoint> endpointGroup;
    private String host;
    private int port;
    private int size;
    private int loop;
    ...
    public WriteServer(String host, int port, int size, int loop) throws IOException{
        ...
        endpointGroup = new RdmaActiveEndpointGroup<WriteServerEndpoint>(1000, false, 128, 4, 128);
    ...
    @Override
    public WriteServerEndpoint createEndpoint(RdmaCmId id, boolean serverSide) throws IOException {
        return new WriteServerEndpoint(endpointGroup, id, serverSide, size);
    }

    public void run() throws Exception {
        //create a server endpoint
        RdmaServerEndpoint<WriteServerEndpoint> serverEndpoint = endpointGroup.createServerEndpoint();
        ...
        WriteServerEndpoint endpoint = serverEndpoint.accept();
...
//            System.out.print(dataBuf.getInt() + ", ");
//        }
//        System.out.println();
    ...
    public static class WriteServerEndpoint extends RdmaActiveEndpoint {
        ...
        public WriteServerEndpoint(RdmaActiveEndpointGroup<WriteServerEndpoint> endpointGroup, RdmaCmId idPriv, boolean serverSide, int size) throws IOException {
